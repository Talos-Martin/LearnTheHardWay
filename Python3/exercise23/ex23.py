...
def print_line(line, encoding, errors):
    ...
    raw_bytes=next_lang.encode(encoding, errors=errors) #weird errors use. why errors = errors??
...
languages=open("languages.txt", encoding="UTF-8") #opens file as UTF-8. Why is that necessary? Why not just open() without encoding specified? 
